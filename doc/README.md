...
| 文档 | 内容 |
|------|------|
| `01-main.md` | main.py：UAC 提权 + 启动逻辑 |
| `02-core.md` | config_parser / backup_engine / restore_engine / manifest_manager / scanner |
| `03-storage.md` | base / local / zip_storage |
| `04-gui.md` | main_window / home_tab / config_tab / settings_tab |
| `05-utils.md` | app_path / path_expander / file_hasher / file_locker |
| `06-config.md` | JSONC 配置文件格式说明（面向用户） |
| `07-models.md` | 数据模型：BackupResult / RestoreResult / BackupVersion / 信号类 |
